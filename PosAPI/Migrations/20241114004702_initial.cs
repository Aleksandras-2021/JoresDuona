    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DefaultShiftPatterns", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 11, 14, 0, 47, 2, 324, DateTimeKind.Utc).AddTicks(2173)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 11, 14, 0, 47, 2, 323, DateTimeKind.Utc).AddTicks(9144))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "UserDefaultShiftPatterns",
                columns: table => new
                {
                    DefaultShiftPatternsId = table.Column<int>(type: "integer", nullable: false),
                    UsersId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserDefaultShiftPatterns", x => new { x.DefaultShiftPatternsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_UserDefaultShiftPatterns_DefaultShiftPatterns_DefaultShiftP~",
                        column: x => x.DefaultShiftPatternsId,
                        principalTable: "DefaultShiftPatterns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserDefaultShiftPatterns_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 11, 14, 0, 47, 2, 324, DateTimeKind.Utc).AddTicks(7969)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 11, 14, 0, 47, 2, 327, DateTimeKind.Utc).AddTicks(1947)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItemDiscounts_Discounts_DiscountId",
                        column: x => x.DiscountId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ItemVariationId = table.Column<int>(type: "integer", nullable: false),
                    OrderItemId = table.Column<int>(type: "integer", nullable: false),
                    Quantity = table.Column<int>(type: "integer", nullable: false),
                    AdditionalPrice = table.Column<decimal>(type: "numeric", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 11, 14, 0, 47, 2, 325, DateTimeKind.Utc).AddTicks(3561)),
                    Amount = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SentAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValue: new DateTime(2024, 11, 14, 0, 47, 2, 327, DateTimeKind.Utc).AddTicks(9391))
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItemDiscounts_DiscountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserDefaultShiftPatterns_UsersId",
                table: "UserDefaultShiftPatterns",
                column: "UsersId");
